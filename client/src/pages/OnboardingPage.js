...
const OnboardingPage = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (formData.namaLengkap && formData.asalInstansi) {
                ...
                <div className="bg-white p-8 sm:p-10 rounded-2xl shadow-lg w-full max-w-md">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            ...
                            <input type="text" name="namaLengkap" onChange={handleChange} className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-300 focus:border-blue-500 transition" required />
                        </div>
                        <div>
                            <label htmlFor="nomorTelepon" className="block text-sm font-medium text-gray-600 mb-1">Nomor Telepon</label>
                            <input type="tel" name="nomorTelepon" onChange={handleChange} className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-300 focus:border-blue-500 transition" />
                        </div>
                        <div>
                            <label htmlFor="asalInstansi" className="block text-sm font-medium text-gray-600 mb-1">Asal Instansi</label>
                            <input type="text" name="asalInstansi" onChange={handleChange} className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-300 focus:border-blue-500 transition" required />
                        </div>
