...
const AdminDashboard = () => {
    ...
    const statsData = [
        { title: 'Total Pengunjung', value: '1,204', icon: <PawIcon />, bgColor: 'bg-blue-200' },
        { title: 'Topik Favorit', value: 'Kuliner', icon: <BookOpenIcon />, bgColor: 'bg-green-200' },
        { title: 'Total Topik', value: '10', icon: <BookOpenIcon />, bgColor: 'bg-yellow-200' },
        { title: 'Total Admin', value: '2', icon: <UsersIcon />, bgColor: 'bg-purple-200' },
    ];
    ...
    return (
        <div>
            {/* Header: Sembunyikan di mobile karena sudah ada di AdminHeader */}
            <div className="hidden lg:flex justify-between items-center mb-8">
                <div>
                    <h1 className="text-3xl font-bold text-gray-800">Halo, {user?.email.split('@')[0] || 'Admin'}</h1>
                    <p className="text-gray-500">Selamat datang kembali di dashboard Anda.</p>
                </div>
                <Link to="#" className="text-sm font-medium text-blue-600 hover:underline">Admin Dashboard</Link>
            </div>

            {/* Grid Kartu Statistik */}
            {/* 1. Ubah grid menjadi 1 kolom di mobile, 2 di tablet, dan 4 di desktop */}
            ...
            <div className="mt-10">
                ...
                {/* Tata letak ini sudah benar (1 kolom di mobile, 3 di desktop) */}
