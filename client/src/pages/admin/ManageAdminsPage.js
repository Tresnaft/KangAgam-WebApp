                        ...
                        <table className="w-full text-left table-fixed">
                            <thead className="bg-gray-100">
                                <tr>
                                    ...
                                    <th className="p-4 font-bold text-gray-600 w-[25%]">Nama</th>
                                    <th className="p-4 font-bold text-gray-600 w-[30%]">E-Mail</th>
                            ...
                            <tbody>
                                {currentItems.map((admin, index) => (
                                    <tr key={admin._id} className="border-b border-gray-200 hover:bg-gray-50">
                                        ...
                                        <td className="p-4 text-gray-700 capitalize">{admin.role}</td>
                                        <td className="p-4 flex justify-center items-center gap-2">
                                            <button
                                                onClick={() => handleOpenModal('form', 'edit', admin)}
                                                className="bg-yellow-100 text-yellow-800 text-xs font-bold px-3 py-1.5 rounded-md hover:bg-yellow-200"
                                            >
                                                Edit
                                            </button>
                                            <button
                                                onClick={() => handleOpenModal('delete', 'delete', admin)}
                                                className="bg-red-100 text-red-800 text-xs font-bold px-3 py-1.5 rounded-md hover:bg-red-200"
                                            >
                                                Delete
                                            </button>
                                        </td>
